...
define('finndis/components/google-search', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    actions: {
      ...
      showPlaceSaved: function showPlaceSaved() {
        var self = this;
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("div");
        dom.setAttribute(el1, "id", "save_overlay");
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h3");
        var el3 = dom.createElement("i");
        dom.setAttribute(el3, "class", "save_overlay--icon fa fa-star");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" Saved!");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        var element23 = dom.childAt(fragment, [21]);
...
define("finndis/templates/edit-labels", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["attribute", "id", ["concat", [["get", "label.labelId", ["loc", [null, [20, 28], [20, 41]]]]]]], ["element", "action", ["deleteLabel", ["get", "label.id", ["loc", [null, [22, 115], [22, 123]]]]], ["on", "click"], ["loc", [null, [22, 92], [22, 136]]]], ["element", "action", ["updateLabel", ["get", "label.id", ["loc", [null, [26, 53], [26, 61]]]]], ["on", "submit"], ["loc", [null, [26, 30], [26, 75]]]], ["inline", "input", [], ["type", "text", "class", "label-editor--input", "value", ["subexpr", "@mut", [["get", "labelName", ["loc", [null, [27, 80], [27, 89]]]]], [], []]], ["loc", [null, [27, 26], [27, 91]]]], ["element", "action", ["updateLabel", ["get", "label.id", ["loc", [null, [30, 113], [30, 121]]]]], ["on", "click"], ["loc", [null, [30, 90], [30, 134]]]]],
          locals: [],
          templates: []
        };
      })();
    ...
    return {
      ...
      statements: [["content", "main-header", ["loc", [null, [1, 0], [1, 15]]]], ["content", "add-label", ["loc", [null, [10, 12], [10, 25]]]], ["block", "each", [["get", "model", ["loc", [null, [17, 22], [17, 27]]]]], [], 0, null, ["loc", [null, [17, 14], [50, 23]]]], ["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [57, 10], [57, 33]]]]], [], 1, null, ["loc", [null, [57, 4], [59, 11]]]]],
      locals: [],
      templates: [child0, child1]
    };
  })());
...
define("finndis/templates/label", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["inline", "main-header", [], ["menuShowLogo", true], ["loc", [null, [1, 0], [1, 33]]]], ["block", "masonry-grid", [], ["items", ["subexpr", "@mut", [["get", "model.places", ["loc", [null, [7, 30], [7, 42]]]]], [], []], "customLayout", true], 0, null, ["loc", [null, [7, 8], [41, 25]]]], ["content", "outlet", ["loc", [null, [43, 8], [43, 18]]]], ["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [47, 10], [47, 33]]]]], [], 1, null, ["loc", [null, [47, 4], [49, 11]]]]],
      locals: [],
      templates: [child0, child1]
    };
  })());
...
if (!runningTests) {
  require("finndis/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_VIEW_LOOKUPS":true,"name":"finndis","version":"0.0.0+8255313a"});
}
